...
public:
    ...
    WaveEquationSolver(size_t gridWidth, size_t gridHeight, size_t numberOfSteps) : m_gridWidth{ gridWidth },
                                                                                    ...
                                                                                    m_timeStep{ gridWidth <= 1000 && gridHeight <= 1000
                                                                                                ? 0.01 : 0.001 },
                                                                                    m_xGridStep{ 4.0 / ((double) gridWidth - 1.0) },
                                                                                    m_yGridStep{ 4.0 / ((double) gridHeight - 1.0) } {
        if (gridWidth % 4 != 0) {
            throw InvalidParameterException{ "Parameter gridWidth must be a multiple of 4" };
        }
    }
